...
function videoSubmit(){
    ...
    count++;
    if(choice>=5){
        document.getElementById("audio").setAttribute("src","../Resource/audio/bg"+(choice-4)+".mp3");
    }else {
        document.getElementById("audio").setAttribute("src","../Resource/audio/bg"+choice+".mp3");
    }
