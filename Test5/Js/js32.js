...
window.onload=function () {
    ...
    category=location.search.split("?")[2].toString();
    init();
...
function Random3() {
    qPath2=Math.floor(Math.random()*sum);
    if(qPath2==0){
        Random3();
    }
}
        ...
        if (choice == answer3[qPath2]){
            switch (choice) {
                case 'A':
                    ...
                    document.getElementById("btn_A3").style.background="#00FF00";
                ...
                case 'B':
                    ...
                    document.getElementById("btn_B3").style.background="#00FF00";
                    document.getElementById("btn_C3").style.background="#FF0000";
                    document.getElementById("btn_D3").style.background="#FF0000";
                    break;
                case 'C':
                    ...
                    document.getElementById("btn_A3").style.background="#FF0000";
                    document.getElementById("btn_B3").style.background="#FF0000";
                    document.getElementById("btn_C3").style.background="#00FF00";
                    document.getElementById("btn_D3").style.background="#FF0000";
                    break;
                case 'D':
                    ...
                    document.getElementById("btn_B3").style.background="#FF0000";
                    document.getElementById("btn_C3").style.background="#FF0000";
                    document.getElementById("btn_D3").style.background="#00FF00";
                    break;
                    }
        }
        else {
